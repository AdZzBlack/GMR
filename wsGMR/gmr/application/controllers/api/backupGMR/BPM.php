...
class BPM extends REST_Controller { 
	...
	function createBPM_post(){     
		...
		if($dataBPM != "")
		{
			$query = "INSERT INTO thbpm(`nomorthdeliveryorder`, `dibuat_pada`, `dibuat_oleh`, `kode`) VALUES($nomor_thDO, '$tanggal', $nomor_user, FC_GENERATE_DELIVERY_ORDER_KODE())";
