...
class BeritaAcara extends REST_Controller { 
	...
	function approve_post(){     
        ...
        if ($this->db->trans_status() === FALSE){
			...
			$vcGCMId  = $this->db->query("SELECT a.gcmid FROM whuser_mobile a JOIN thberitaacara b ON b.dibuat_oleh = a.nomormhuser $nomor ORDER BY a.nomor DESC LIMIT 1")->row()->gcmid;
			$this->send_gcm($vcGCMId, $this->ellipsis('Berita Acara Elevasi Approved'),'Approval','Index','0','0');
        }
