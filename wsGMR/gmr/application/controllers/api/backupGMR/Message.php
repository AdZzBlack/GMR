...
class Message extends REST_Controller { 
	...
	function sendPrivateMessage_post(){     
        ...
        if ($this->db->trans_status() === FALSE){
			...
			$nama = $this->db->query("SELECT a.nama FROM mhadmin a JOIN whuser_mobile b ON b.nomormhuser = a.nomor WHERE b.nomor = $userfrom_nomor")->row()->nama;
	...
	// --- POST GET SPECIFIC PRIVATE MESSAGE --- //
	function getSpecificPrivateMessage_post(){     
        $data['data'] = array();
