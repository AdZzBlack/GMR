...
public class ChooseApprovalElevasi extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        getActivity().setTitle("Approval Elevasi");
        ...
        lv_choose.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View v,
                ...
                String actionUrl = "BeritaAcara/alldataneedapproval/";
